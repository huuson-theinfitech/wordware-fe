                ...
                {isLoading ? (
                    ...
                    <div className='flex-col flex space-x-6 tracking-[2px] sm:flex-row sm:flex-wrap'>
                        <div className='space-x-2'>
                            <span className='text-red-coral'>{data?.followers_count ?
                                data?.followers_count.toLocaleString() : "0"}</span>
                            <span>FOLLOWERS</span>
                        </div>
                        <div className='space-x-2'>
                            <span className='text-blue-cobalt'>{data?.following_count ? 
                                data?.following_count.toLocaleString() : "0"}</span>
                            <span>FOLLOWING</span>
                        </div>
                    </div>
                )}
